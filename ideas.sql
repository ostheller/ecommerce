...
CREATE TABLE `admins` (
  ...
  KEY `fk_admins_user_levels1_idx` (`user_level_id`)
...
CREATE TABLE `clients` (
  ...
  `same_as_shipping` tinyint(1) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `images` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_images_ideas1_idx` (`idea_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_users_shopping_cart1_idx` (`shopping_cart_id`),
...
-- Dump completed on 2015-07-20 14:39:58
